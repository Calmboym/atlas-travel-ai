...
| Footer | `components/layout/footer.tsx` | DESIGNSYS | `DESIGNSYS-03` | ✅ Built (2026-08-15) | LAND, marketing pages | **Not previously tracked in this matrix** — added during this reconciliation; real file, confirmed in use by `MarketingLayout`. **Flagged 2026-08-19 (AUTH-01 audit, not fixed — different owning task):** `LEGAL_LINKS`'s "Privacy"/"Terms" labels are hardcoded English, same pattern AuthLayout had before this session's fix. Whoever next touches this file or ships real `LAND-01` content should localize it the same way. |
